    ...
    <div data-dir="B" style={{ background: "var(--bg)", color: "var(--ink)", fontFamily: "var(--sans)", minHeight: "100%" }}>
      ...
      <header style={{ padding: "24px 48px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <nav style={{ display: "flex", gap: 4, padding: 4, background: "var(--paper)", borderRadius: 999, fontSize: 13 }}>
          {["Home","The quest","Concerns","Catalogue","Notes","About"].map((l, i) => (
        ...
        <a href="#" style={{ padding: "10px 22px", borderRadius: 999, background: "var(--ink)", color: "var(--paper)", fontSize: 13, fontWeight: 500, textDecoration: "none" }}>Take the quest</a>
      </header>
      ...
      <section style={{ padding: "60px 48px 100px", position: "relative" }}>
        ...
        <div style={{ position: "relative", maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "8px 16px", background: "var(--paper)", borderRadius: 999, fontSize: 12, color: "var(--ink-2)", marginBottom: 32, border: "1px solid var(--rule)" }}>
            ...
            89 evidence-graded interventions · last updated 7 May 2026
          </div>
          <h1 style={{ fontFamily: "var(--serif)", fontSize: 110, lineHeight: 1, letterSpacing: "-0.02em", fontWeight: 400, margin: 0, fontStyle: "italic", maxWidth: 1000 }}>
            A calm, considered guide<br/>to a longer, better life.
          </h1>
          <p style={{ fontSize: 19, lineHeight: 1.55, color: "var(--ink-2)", maxWidth: 600, marginTop: 32, fontFamily: "var(--sans)" }}>
            We've read the studies so you don't have to. Eighty-nine medications, supplements and habits — graded on real human evidence, ranked by what's actually worth your time.
          </p>
          <div style={{ display: "flex", gap: 16, marginTop: 40 }}>
            <a href="#" style={{ padding: "16px 32px", borderRadius: 999, background: "var(--ink)", color: "var(--paper)", textDecoration: "none", fontSize: 15, fontWeight: 500 }}>Start the quest →</a>
            <a href="#" style={{ padding: "16px 32px", borderRadius: 999, background: "var(--paper)", color: "var(--ink)", textDecoration: "none", fontSize: 15, fontWeight: 500, border: "1px solid var(--rule)" }}>Browse the foundation</a>
          </div>
          ...
          <div style={{ marginTop: 80, padding: 32, background: "var(--paper)", borderRadius: 28, border: "1px solid var(--rule)", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 32, position: "relative", zIndex: 2 }}>
            {[
              { n: "89", l: "interventions", s: "Medications, supplements, lifestyle" },
              { n: "12", l: "foundations", s: "Universal, low-cost, high-evidence" },
              { n: "320+", l: "studies cited", s: "Each linked to PubMed or DOI" },
              { n: "12", l: "concerns", s: "Conditions and aging mechanisms" },
            ].map((s, i) => (
      ...
      <section style={{ padding: "0 48px 100px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <div className="kicker" style={{ marginBottom: 12 }}>Three ways in</div>
            <h2 style={{ fontFamily: "var(--serif)", fontSize: 56, fontWeight: 400, fontStyle: "italic", margin: 0, letterSpacing: "-0.02em" }}>Where shall we begin?</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
            {[
              { t: "Take the quest", s: "A few questions about you. Get a personal shortlist of 5–12 things worth your attention.", time: "4 min", cta: "Start", tex: "orbit", color: "var(--accent)" },
              { t: "By concern", s: "Twelve conditions — heart, brain, muscle, metabolism. Mapped to the evidence.", time: "Browse", cta: "Explore concerns", tex: "topo", color: "var(--warm)" },
              { t: "Foundation Stack", s: "Twelve things to do regardless. Strongest evidence, lowest cost, lowest risk.", time: "12 items", cta: "See the stack", tex: "wave", color: "var(--accent-2)" },
            ].map((c, i) => (
      ...
      <section style={{ padding: "100px 48px", background: "var(--bg-2)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 64, marginBottom: 56, alignItems: "end" }}>
            <div>
              <div className="kicker" style={{ marginBottom: 12 }}>The Foundation</div>
              <h2 style={{ fontFamily: "var(--serif)", fontSize: 64, fontStyle: "italic", fontWeight: 400, lineHeight: 1, margin: 0, letterSpacing: "-0.02em" }}>The twelve things, first.</h2>
            </div>
            <p style={{ fontSize: 17, lineHeight: 1.6, color: "var(--ink-2)", margin: 0 }}>
              Universal basics with the strongest human evidence and the lowest risk. Most are free or under twenty dollars a month. Do these before you spend a cent on anything fashionable.
            </p>
          </div>
              ...
              <article key={it.slug} style={{ background: "var(--paper)", borderRadius: 20, padding: 24, display: "flex", flexDirection: "column", gap: 14, minHeight: 240 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 11, color: "var(--score-hi)", fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase" }}>
                    <span style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--score-hi)" }}/> Foundation
                  </span>
      ...
      <section style={{ padding: "100px 48px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            <div className="kicker" style={{ marginBottom: 12 }}>By concern</div>
            <h2 style={{ fontFamily: "var(--serif)", fontSize: 64, fontStyle: "italic", fontWeight: 400, margin: 0, letterSpacing: "-0.02em" }}>What worries you most?</h2>
          </div>
          ...
          <div style={{ textAlign: "center", marginTop: 32 }}>
            <a href="#" style={{ color: "var(--accent)", fontSize: 14, fontWeight: 500 }}>All twelve concerns →</a>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "100px 48px", background: "var(--accent-soft)", color: "var(--accent)" }}>
        <div style={{ maxWidth: 880, margin: "0 auto", textAlign: "center" }}>
          <div className="kicker" style={{ marginBottom: 24, color: "var(--accent)" }}>Editor's note</div>
          <p style={{ fontFamily: "var(--serif)", fontSize: 40, lineHeight: 1.2, fontStyle: "italic", fontWeight: 400, margin: 0, color: "var(--ink)", letterSpacing: "-0.02em" }}>
            "Most of what works is unfashionable. Sleep, lifting, walking, friends, fish. The fashionable molecules come last, if at all — and almost always under medical supervision."
          </p>
          <div style={{ marginTop: 32, fontSize: 13, color: "var(--ink-2)" }}>From <em style={{ color: "var(--ink)" }}>Inflammation: the through-line</em> · 7 May 2026</div>
        </div>
      </section>
      ...
      <section style={{ padding: "100px 48px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 48 }}>
            <div>
              <div className="kicker" style={{ marginBottom: 12 }}>Recent notes</div>
              <h2 style={{ fontFamily: "var(--serif)", fontSize: 56, fontStyle: "italic", fontWeight: 400, margin: 0, letterSpacing: "-0.02em" }}>Long form, slow takes.</h2>
            </div>
            <a href="#" style={{ color: "var(--accent)", fontSize: 14, fontWeight: 500 }}>All notes →</a>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr", gap: 24 }}>
            <article style={{ background: "var(--paper)", borderRadius: 24, overflow: "hidden", display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ padding: 28, display: "flex", flexDirection: "column", gap: 12 }}>
                <div className="mono" style={{ color: "var(--ink-3)" }}>{NOTES[0].date} · Featured</div>
      ...
      <footer style={{ padding: "80px 48px", background: "var(--ink)", color: "var(--paper)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1fr", gap: 48 }}>
          <div>
            ...
            <p style={{ fontSize: 14, lineHeight: 1.6, color: "rgba(252,248,241,0.7)", maxWidth: 360, margin: 0 }}>Evidence-graded longevity. No supplement industry money, no affiliate links, no breathless tone.</p>
          </div>
          {[
            { h: "Catalogue", l: ["Medications", "Supplements", "Lifestyle"] },
            { h: "Method",    l: ["How we score", "Conflicts", "Updates"] },
            { h: "Connect",   l: ["Newsletter", "Contact", "About"] },
          ].map((g, i) => (
            <div key={i}>
