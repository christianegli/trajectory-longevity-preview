    ...
    <div data-dir="C" style={{ background: "var(--bg)", color: "var(--ink)", fontFamily: "var(--sans)", minHeight: "100%", fontSize: 14 }}>
      ...
      <header style={{ borderBottom: "1px solid var(--rule)" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "16px 64px", display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid var(--rule)" }}>
          <span className="mono" style={{ fontSize: 10 }}>Trajectory · Longévité fondée sur les preuves · Mise à jour le 7 mai 2026</span>
          <span className="mono" style={{ fontSize: 10 }}>89 interventions · 320+ études · Sans publicité</span>
        </div>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "20px 64px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <nav style={{ display: "flex", gap: 32, fontSize: 13, color: "var(--ink-2)" }}>
            {["La quête","Par préoccupation","Médicaments","Compléments","Mode de vie","Notes","Méthodologie","À propos"].map(l => <a key={l} href="#" style={{ color: "inherit", textDecoration: "none" }}>{l}</a>)}
          </nav>
        </div>
      </header>
      ...
      <section style={{ borderBottom: "1px solid var(--rule)" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "120px 64px", display: "grid", gridTemplateColumns: "100px 1fr 320px", gap: 64 }}>
          <div className="mono" style={{ color: "var(--ink-3)", fontSize: 10, lineHeight: 1.8 }}>
            ...
            <div style={{ marginTop: 24 }}>LECTURE</div>
          ...
          <div>
            <h1 style={{ fontFamily: "var(--serif)", fontSize: 96, lineHeight: 0.95, letterSpacing: "-0.025em", fontWeight: 400, margin: 0 }}>
              Quatre-vingt-neuf façons<br/>de vivre plus longtemps,<br/>évaluées honnêtement.
            </h1>
            <p style={{ fontFamily: "var(--serif)", fontSize: 22, lineHeight: 1.4, color: "var(--ink-2)", marginTop: 40, maxWidth: 640, fontStyle: "italic" }}>
              La plupart de ce qui fonctionne n'est pas à la mode : sommeil, marche, musculation, poisson, amis. Les molécules à la mode viennent en dernier, si elles viennent. Nous avons lu les études pour vous.
            </p>
            <div style={{ marginTop: 56, display: "flex", gap: 32, alignItems: "center", paddingTop: 24, borderTop: "1px solid var(--rule)" }}>
              <a href="#" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 22px", background: "var(--ink)", color: "var(--paper)", fontSize: 13, fontWeight: 500, textDecoration: "none", letterSpacing: "0.02em" }}>Commencer la quête <span aria-hidden>→</span></a>
              <a href="#" style={{ fontSize: 13, color: "var(--ink)", borderBottom: "1px solid var(--ink)", paddingBottom: 4 }}>Parcourir le socle</a>
              <a href="#" style={{ fontSize: 13, color: "var(--ink-2)" }}>Notre méthode de notation →</a>
            </div>
          </div>
          <aside style={{ borderLeft: "1px solid var(--rule)", paddingLeft: 32 }}>
            <div className="mono" style={{ fontSize: 10, color: "var(--ink-3)", marginBottom: 16 }}>Le catalogue en un coup d'œil</div>
            <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
              {[
                { l: "Socle, niveau 1", n: "12", s: "Bases universelles. Preuves les plus solides, risque le plus faible." },
                { l: "Ciblé, niveau 2", n: "56", s: "Pour des pathologies ou mécanismes de vieillissement spécifiques." },
                { l: "Frontière, niveau 3", n: "5", s: "Prometteur, mais les preuves humaines sont encore attendues." },
              ].map((t, i) => (
            ...
            <div className="mono" style={{ fontSize: 10, color: "var(--ink-3)", marginTop: 24, lineHeight: 1.7 }}>
              <div>16 médicaments</div>
              <div>32 compléments</div>
              <div>41 mode de vie</div>
            </div>
          </aside>
        </div>
      </section>
      ...
      <section style={{ borderBottom: "1px solid var(--rule)" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "80px 64px" }}>
          <div className="mono" style={{ color: "var(--ink-3)", fontSize: 10, marginBottom: 32 }}>§ I — Comment utiliser ce site</div>
          <div style={{ display: "grid", gridTemplateColumns: "100px 1fr 1fr 1fr", gap: 0 }}>
            <div></div>
            {[
              { n: "001", t: "Commencer la quête", s: "Répondez à un bref questionnaire sur votre âge, votre corps, votre mode de vie et vos pathologies. Recevez une sélection personnelle, classée, de cinq à douze interventions qui méritent votre temps.", time: "4 min", cta: "Commencer" },
              { n: "002", t: "Parcourir par préoccupation", s: "Douze pathologies et mécanismes du vieillissement, chacun relié aux interventions qui agissent dessus. La plupart des éléments apparaissent sous plus d'une rubrique.", time: "Parcourir", cta: "Préoccupations" },
              { n: "003", t: "Lire le socle", s: "Douze choses à faire quel que soit votre profil. Preuves humaines les plus solides, risque le plus faible, coût le plus bas. La plupart sont gratuites ou coûtent moins de 20 € par mois.", time: "12 éléments", cta: "Socle" },
            ].map((c, i) => (
      ...
      <section style={{ borderBottom: "1px solid var(--rule)" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "100px 64px" }}>
          <div className="mono" style={{ color: "var(--ink-3)", fontSize: 10, marginBottom: 32 }}>§ II — Le socle</div>
          <div style={{ display: "grid", gridTemplateColumns: "100px 1fr", gap: 64, marginBottom: 64 }}>
            <div></div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "end" }}>
              <h2 style={{ fontFamily: "var(--serif)", fontSize: 64, fontWeight: 400, lineHeight: 1, margin: 0, letterSpacing: "-0.025em" }}>Les douze choses,<br/>avant tout le reste.</h2>
              <p style={{ fontSize: 16, color: "var(--ink-2)", lineHeight: 1.6, margin: 0 }}>Bases universelles, avec les preuves humaines les plus solides et le risque le plus faible. Représentées par score combiné (efficacité × certitude), puis détaillées ci-dessous.</p>
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "100px 1fr", gap: 64, marginBottom: 80 }}>
            <div className="mono" style={{ fontSize: 10, color: "var(--ink-3)", lineHeight: 1.7 }}>
              <div>FIG. 01</div>
              <div style={{ color: "var(--ink-2)", marginTop: 4, textTransform: "none", letterSpacing: 0 }}>Efficacité × certitude pour le socle.</div>
            </div>
            <div style={{ position: "relative", height: 380, padding: "20px 40px 40px 40px", border: "1px solid var(--rule)", background: "var(--paper)" }}>
              ...
              <div className="mono" style={{ position: "absolute", bottom: 12, left: "50%", transform: "translateX(-50%)", color: "var(--ink-3)", fontSize: 9 }}>CERTITUDE · 0 — 10 →</div>
              <div className="mono" style={{ position: "absolute", left: 12, top: "50%", transform: "translate(-50%, -50%) rotate(-90deg)", color: "var(--ink-3)", fontSize: 9, transformOrigin: "center" }}>EFFICACITÉ</div>
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "100px 1fr", gap: 64 }}>
            ...
            <div>
              <div style={{ display: "grid", gridTemplateColumns: "32px 1.4fr 2fr 100px 100px 80px", gap: 16, padding: "12px 0", borderTop: "1px solid var(--ink)", borderBottom: "1px solid var(--rule)", fontFamily: "var(--mono)", fontSize: 10, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--ink-2)" }}>
                <span>N°</span><span>Intervention</span><span>Résumé</span><span>Coût</span><span>Effet / Cert.</span><span>Pr.</span>
              </div>
              {FOUNDATION.map((it, i) => (
                <a key={it.slug} href="#" style={{ display: "grid", gridTemplateColumns: "32px 1.4fr 2fr 100px 100px 80px", gap: 16, padding: "20px 0", borderBottom: "1px solid var(--rule)", color: "inherit", textDecoration: "none", alignItems: "center" }}>
                  ...
                  <span className="mono" style={{ color: "var(--accent)" }}>Pr {it.ev}</span>
                </a>
              ))}
            </div>
          </div>
      ...
      <section style={{ borderBottom: "1px solid var(--rule)" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "100px 64px" }}>
          <div className="mono" style={{ color: "var(--ink-3)", fontSize: 10, marginBottom: 32 }}>§ III — Par préoccupation</div>
          <div style={{ display: "grid", gridTemplateColumns: "100px 1fr 1fr", gap: 64 }}>
            <div></div>
            <h2 style={{ fontFamily: "var(--serif)", fontSize: 64, fontWeight: 400, lineHeight: 1, letterSpacing: "-0.025em", margin: 0 }}>Douze préoccupations,<br/>et ce qui les concerne.</h2>
            <p style={{ fontSize: 16, color: "var(--ink-2)", lineHeight: 1.6, alignSelf: "end", margin: 0 }}>Mécanismes du vieillissement et pathologies nommées. Chacun renvoie aux interventions ayant des effets significatifs, classés par niveau de preuve, sur l'issue concernée.</p>
          </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 0 }}>
              {CONCERNS.map((c, i) => (
                <a key={c.slug} href="#" style={{ padding: "28px 32px 28px 0", borderTop: i < 2 ? "1px solid var(--ink)" : "1px solid var(--rule)", borderRight: i % 2 === 0 ? "1px solid var(--rule)" : "none", paddingLeft: i % 2 === 1 ? 32 : 0, color: "inherit", textDecoration: "none", display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 24 }}>
                  ...
                  <span className="mono" style={{ color: "var(--accent)", flexShrink: 0 }}>{c.count} ÉLÉMENTS</span>
                </a>
              ))}
            </div>
          </div>
      ...
      <section style={{ borderBottom: "1px solid var(--rule)" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "100px 64px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "100px 1fr 1fr", gap: 64, alignItems: "end", marginBottom: 56 }}>
            <div className="mono" style={{ color: "var(--ink-3)", fontSize: 10 }}>§ IV — Notes récentes</div>
            <h2 style={{ fontFamily: "var(--serif)", fontSize: 64, fontWeight: 400, lineHeight: 1, letterSpacing: "-0.025em", margin: 0 }}>Long format. <em style={{ color: "var(--accent)" }}>Lentement.</em></h2>
            <a href="#" style={{ alignSelf: "end", color: "var(--accent)", fontSize: 13, fontWeight: 500, borderBottom: "1px solid var(--accent)", paddingBottom: 4, justifySelf: "end" }}>Toutes les notes →</a>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "100px 1fr", gap: 64 }}>
            <div></div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 0 }}>
              {NOTES.map((n, i) => (
                <article key={i} style={{ padding: "32px 32px 32px 0", borderTop: i < 2 ? "1px solid var(--ink)" : "1px solid var(--rule)", borderRight: i % 2 === 0 ? "1px solid var(--rule)" : "none", paddingLeft: i % 2 === 1 ? 32 : 0 }}>
                  <div className="mono" style={{ color: "var(--ink-3)", marginBottom: 12 }}>{n.date} · Essai N° {String(i+1).padStart(2,"0")}</div>
                  ...
                  <a href="#" style={{ display: "inline-block", marginTop: 16, fontSize: 12, color: "var(--accent)", letterSpacing: "0.05em", textTransform: "uppercase", fontFamily: "var(--mono)" }}>Lire l'essai →</a>
                </article>
              ))}
            </div>
          </div>
      ...
      <footer style={{ background: "var(--accent)", color: "var(--paper)" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "80px 64px", display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1fr 1fr", gap: 48 }}>
          <div>
            ...
            <p style={{ fontSize: 14, lineHeight: 1.6, color: "rgba(255,255,255,0.75)", maxWidth: 320, margin: 0 }}>Interventions de longévité fondées sur les preuves. Aucun financement de l'industrie des compléments, aucun lien d'affiliation, aucun ton emphatique.</p>
          </div>
          {[
            { h: "Catalogue", l: ["Médicaments", "Compléments", "Mode de vie", "Les 89 entrées"] },
            { h: "Par préoccupation", l: ["Cœur", "Cerveau", "Métabolique", "Les douze"] },
            { h: "Méthode", l: ["Notre méthode de notation", "Conflits d'intérêts", "Mises à jour", "Sources"] },
            { h: "Suivre", l: ["Newsletter", "Contact", "À propos", "Notes"] },
          ].map((g, i) => (
            <div key={i}>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.15)" }}>
          <div className="mono" style={{ maxWidth: 1280, margin: "0 auto", padding: "20px 64px", fontSize: 10, color: "rgba(255,255,255,0.5)", display: "flex", justifyContent: "space-between" }}>
            ...
            <span>Composé en Spectral & Inter</span>
          </div>
        </div>
      </footer>
    </div>
