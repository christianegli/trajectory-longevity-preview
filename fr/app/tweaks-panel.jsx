...
function TweaksPanel({ title = 'Réglages', noDeckControls = false, children }) {
    ...
    <>
      ...
      <div ref={dragRef} className="twk-panel" data-noncommentable=""
        ...
        <div className="twk-hd" onMouseDown={onDragStart}>
          <b>{title}</b>
          <button className="twk-x" aria-label="Fermer les réglages"
        ...
        <div className="twk-body">
          ...
          {hasDeckStage && railEnabled && !noDeckControls && (
            <TweakSection label="Deck">
              <TweakToggle label="Barre de miniatures" value={railVisible} onChange={toggleRail} />
            </TweakSection>
          )}
        </div>
      </div>
