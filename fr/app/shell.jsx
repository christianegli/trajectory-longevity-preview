...
const ROUTES = [
  { key: "dashboard", label: "Aujourd'hui" },
  { key: "catalogue", label: "Catalogue" },
  { key: "playbooks", label: "Protocoles" },
  { key: "compare", label: "Comparer" },
  { key: "nutrition", label: "Nutrition" },
  { key: "concerns", label: "Par sujet" },
  ...
  return (
    <header className="top">
      <div className="brand" onClick={() => setRoute("dashboard")} style={{ cursor: "pointer" }}>
        ...
        <span className="brand-tagline">Longévité fondée sur les preuves</span>
      </div>
      <nav className="nav">
        {ROUTES.map(r => (
      ...
      <div className="right">
        <div className="language-switcher" onBlur={(event) => {
          ...
          <button type="button" className="language-trigger" onClick={() => setLanguageOpen(open => !open)} aria-haspopup="menu" aria-expanded={languageOpen} title="Changer de langue">
            {activeLanguageLabel}
        ...
        <form className="search" onSubmit={runSearch}>
          ...
          <input
            ...
            placeholder={`Rechercher parmi ${itemCount} interventions`}
          />
