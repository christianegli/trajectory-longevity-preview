...
function TweaksPanel({ title = 'Anpassungen', noDeckControls = false, children }) {
    ...
    <>
      ...
      <div ref={dragRef} className="twk-panel" data-noncommentable=""
        ...
        <div className="twk-hd" onMouseDown={onDragStart}>
          <b>{title}</b>
          <button className="twk-x" aria-label="Anpassungen schließen"
        ...
        <div className="twk-body">
          ...
          {hasDeckStage && railEnabled && !noDeckControls && (
            <TweakSection label="Folien">
              <TweakToggle label="Miniaturansicht-Leiste" value={railVisible} onChange={toggleRail} />
            </TweakSection>
          )}
        </div>
      </div>
