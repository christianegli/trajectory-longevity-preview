...
(function () {
  ...
  const STEPS = {
    intro: {
      ...
      lede: "Acht kurze Schritte. Etwa drei Minuten. Wir bauen Ihnen einen persönlichen, realistischen Plan — keine Einkaufsliste mit 30 Supplementen.",
      render: renderIntro,
      hideProgress: true,
    },
    basics: {
    ...
    food: {
      title: "How you eat",
      lede: "Grob geschätzt. Wir zählen keine Makros.",
      render: renderFood,
    ...
    meds_conds: {
      title: "Was Sie nehmen, was Sie haben",
      lede: "Wichtig für die Sicherheit: Wir filtern Konflikte heraus.",
  ...
  function renderIntro() {
    ...
    return el('div', { class: 'wiz-intro-v2' },
      el('div', { class: 'wiz-intro-promise' },
        ...
        el('span', null, 'Läuft komplett auf Ihrem Gerät — nichts wird gesendet oder gespeichert.')
      ),
      el('div', { class: 'wiz-intro-promise' },
        el('span', { class: 'wiz-intro-icon-pill' }, '🧬'),
        el('span', null,
          el('strong', null, 'Ehrliche Eingaben, ehrliche Ausgaben. '),
          'Wer „sitzend" angibt, bekommt einen besseren Plan als wer schummelt.'
        )
      ),
  ...
  function renderBasics() {
    return el('div', { class: 'wiz-basics' },
      ...
      el('div', { class: 'wiz-field' },
        el('label', { class: 'wiz-field-label' }, 'Bei Geburt zugewiesenes Geschlecht'),
        radioGroup('sex',
          [['female', 'Weiblich'], ['male', 'Männlich'], ['skip', 'Keine Angabe']],
          state.answers.sex,
  ...
  function renderPregnancy() {
    return radioGroup('pregnant', [
      ['yes', 'Ja — schwanger, stillend oder aktiv versuchend',
        'We\'ll prioritise folate and remove anything contraindicated in pregnancy.'],
      ['no', 'Nein', 'Standardempfehlungen.'],
  ...
  function renderWhy() {
    return el('div', null,
      ...
      checkGroup('goals', [
        ['longevity', 'Länger leben (allgemeine Healthspan)', 'Breites Fundament, kein spezifisches Anliegen.'],
        ['cardiovascular', 'Herzgesundheit', 'Evidenzreichste Kategorie.'],
        ['cognitive', 'Gehirn & Gedächtnis', 'Schlaf, Cardio, Omega-3, soziale Bindung sind die Hebel.'],
        ['metabolic', 'Stoffwechsel / Gewicht', 'Blutzuckerkontrolle, Körperzusammensetzung, Fettleber.'],
        ['frailty', 'Stark bleiben im Alter', 'Muskel, Knochen, Balance — Sarkopenie-Prävention.'],
        ['energy', 'Energie & Vitalität', 'Schlaf, Eisen, Schilddrüse, Mitochondrien.'],
        ['performance', 'Sportliche Leistung', 'Sportlich-relevante Interventionen.'],
  ...
  function renderMovement() {
    return el('div', null,
      el('p', { class: 'wiz-q-help' }, 'Ehrliche Einschätzung einer durchschnittlichen Woche.'),
      radioGroup('exercise', [
        ['sedentary', 'Sitzend', 'Weniger als eine strukturierte Einheit pro Woche.'],
        ['cardio_only', 'Nur Cardio', 'Gehen, Laufen, Radfahren. Kein Krafttraining.'],
        ['strength_only', 'Nur Kraft', 'Krafttraining, aber kein Cardio.'],
        ['both', 'Beides', 'Mix aus Cardio und Kraft die meisten Wochen.'],
        ['athlete', 'Hohes Volumen', 'Training 5+ Stunden/Woche, wettkampfnah.'],
  ...
  function renderSleep() {
    return radioGroup('sleep', [
      ['under_6', 'Unter 6 Stunden die meisten Nächte', 'Das größte Gesundheits-Upgrade für die meisten Menschen.'],
      ['6_7', '6–7 hours', 'Etwas kurz. Lohnt sich, das zu beheben.'],
      ['7_9', '7–9 Stunden, ziemlich konstant', 'Da, wo Sie sein wollen.'],
      ['over_9', 'Über 9 Stunden', 'Manchmal ein Hinweis auf zugrunde liegende Probleme.'],
      ['irregular', 'Stark unregelmäßig', 'Schichtarbeit, Jetlag, Kinder — Variabilität zählt mehr als die Gesamtdauer.'],
  ...
  function renderFood() {
    return el('div', null,
      el('div', { class: 'wiz-field' },
        el('label', { class: 'wiz-field-label' }, 'Was Ihrer üblichen Ernährung am nächsten kommt'),
        radioGroup('diet', [
          ['western', 'Standard-westlich', 'Viel Verarbeitetes, wenig Fisch/Gemüse.'],
          ['mediterranean', 'Mediterran-orientiert', 'Olivenöl, Fisch, Gemüse, Hülsenfrüchte.'],
          ['vegetarian', 'Vegetarisch'],
          ['vegan', 'Vegan'],
          ['keto', 'Keto / low-carb'],
          ['mixed', 'Gemischt / schwer einzuordnen'],
      ...
      el('div', { class: 'wiz-field' },
        ...
        radioGroup('diet_quality_self', [
          ...
          ['good', 'Gut', 'Überwiegend unverarbeitete Lebensmittel, Gemüse, Fisch usw.'],
  ...
  function renderHabits() {
    return el('div', null,
      el('div', { class: 'wiz-field' },
        el('label', { class: 'wiz-field-label' }, 'Raucherstatus'),
        radioGroup('smoking', [
          ['never', 'Nie geraucht', 'Oder unter 100 Zigaretten im ganzen Leben.'],
          ['former', 'Ehemals geraucht, aufgehört', 'Risiko sinkt schnell — der größte CV-Nutzen kehrt in 1–5 Jahren zurück.'],
  ...
  function renderReview() {
    ...
    return el('div', { class: 'wiz-review' },
      ...
      el('p', { class: 'wiz-review-edit' },
        'Um etwas zu ändern, „Zurück“ drücken. Dann „Generieren“.')
    );
  }
  ...
  function renderShell(stepId) {
    ...
    const ctaLabel = isLast ? 'Plan anzeigen →' : (idx === 0 ? 'Start →' : 'Weiter →');
    nav.appendChild(el('button', {
  ...
  function downloadStackJson(ranked, alreadyDoing) {
    const payload = {
      ...
      disclaimer: 'Regelbasiert generiert, kein Arztersatz. Sprechen Sie mit Ihrer Ärztin.',
    };
        ...
        el('div', { class: 'wiz-rec-titlewrap' },
          ...
          el('div', { class: 'wiz-rec-meta' },
            el('span', { class: `tier-badge tier-${tier}` },
              ...
              el('span', { class: 'tier-label' }, ['Fundament','Gezielt','Frontier'][tier-1])),
