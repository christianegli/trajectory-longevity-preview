      ...
      <section className="home-hero">
        <div>
          ...
          <div className="note" style={{ maxWidth: 560 }}>
            Evidence based longevity means every claim has to survive the same questions: <em>does it work in humans</em>, <em>how large is the effect</em>, and <em>what would make a normal person act differently</em>. No supplements to sell, no telemedicine, no Pro tier — just the evidence, kept current, in plain language.
            <span className="sig">— Trajectory editorial team</span>
          </div>
        </div>
        <div className="home-stats card-pad numeric">
          <div className="kicker" style={{ marginBottom: 18 }}>The catalogue</div>
      ...
      <section style={{ marginBottom: 56 }}>
        <div className="decision-grid">
          ...
          <div className="card clickable card-pad" onClick={() => setRoute("nutrition")}>
            ...
            <h2 className="display" style={{ fontSize: 30, lineHeight: 1.05, margin: "0 0 10px" }}>Food before stacks.</h2>
            <p style={{ fontSize: 14.5, lineHeight: 1.55, color: "var(--ink-2)", margin: "0 0 18px", fontFamily: "var(--news)" }}>
      ...
      <section style={{ marginBottom: 56 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }}>
          {concerns.map(key => {
            ...
            return (
              <div key={key} className="card clickable card-pad" onClick={() => setRoute("concerns")}>
